...
static constexpr ExtensionFunctionEntry EXTENSION_FUNCTIONS[] = {
    ...
    {"lm_diskann_compact_index", "lm_diskann", CatalogType::PRAGMA_FUNCTION_ENTRY},
    {"lm_diskann_index_scan", "lm_diskann", CatalogType::TABLE_FUNCTION_ENTRY},
    ...
    {"lm_diskann_join", "lm_diskann", CatalogType::TABLE_MACRO_ENTRY},
    {"lm_diskann_match", "lm_diskann", CatalogType::TABLE_MACRO_ENTRY},
